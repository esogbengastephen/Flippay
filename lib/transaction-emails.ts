            ...
            <tr>
              <td align="center" style="padding: 20px 0;">
                <table role="presentation" style="max-width: 600px; width: 100%; border-collapse: collapse; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                  <tr>
                    <td style="padding: 40px 40px 20px; text-align: center; background: linear-gradient(135deg, #00BFFF 0%, #00A3E0 100%); border-radius: 12px 12px 0 0;">
                  ...
                  <tr>
                    <td style="padding: 40px;">
                      ...
                      <div style="background: linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%); padding: 20px; border-radius: 12px; margin: 20px 0;">
                        ...
                        <p style="margin: 0; font-size: 24px; font-weight: bold; color: #00BFFF;">₦${parseFloat(ngnAmount.toString()).toLocaleString()}</p>
                      </div>
                ...
                <table role="presentation" style="max-width: 600px; width: 100%; border-collapse: collapse; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                  ...
                  <tr>
                    <td style="padding: 40px;">
                      ...
                      <div style="background: linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%); padding: 20px; border-radius: 12px; margin: 20px 0;">
                        <p style="margin: 0 0 10px; color: #64748b; font-size: 14px; font-weight: 600;">Amount Paid</p>
                        <p style="margin: 0 0 20px; font-size: 24px; font-weight: bold; color: #00BFFF;">₦${parseFloat(ngnAmount.toString()).toLocaleString()}</p>
                        
                        <p style="margin: 20px 0 10px; color: #64748b; font-size: 14px; font-weight: 600;">Tokens Received</p>
                        <p style="margin: 0 0 20px; font-size: 24px; font-weight: bold; color: #00BFFF;">${parseFloat(sendAmount).toLocaleString()} SEND</p>
                      ...
                      ${txHash ? `
                        <div style="text-align: center; margin: 30px 0;">
                          <a href="${explorerUrl}" style="display: inline-block; padding: 12px 24px; background: linear-gradient(135deg, #00BFFF 0%, #00A3E0 100%); color: #0f172a; text-decoration: none; border-radius: 8px; font-weight: bold;">
                  ...
                  <tr>
                    <td style="padding: 40px;">
                      ...
                      <div style="background: linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%); padding: 20px; border-radius: 12px; margin: 20px 0;">
                        ...
                        <p style="margin: 0 0 20px; font-size: 24px; font-weight: bold; color: #00BFFF;">${amountDisplay}</p>
                      ...
                      <div style="text-align: center; margin: 30px 0;">
                        <a href="${invoiceUrl}" style="display: inline-block; padding: 12px 24px; background: linear-gradient(135deg, #00BFFF 0%, #00A3E0 100%); color: #0f172a; text-decoration: none; border-radius: 8px; font-weight: bold; margin-bottom: 15px;">
                          View & Pay Invoice
                        </a>
                      ...
                      <p style="margin: 20px 0 0; color: #64748b; font-size: 12px; text-align: center; word-break: break-all;">
                        Or copy this link: <a href="${invoiceUrl}" style="color: #00BFFF; text-decoration: underline;">${invoiceUrl}</a>
                      </p>
                    </td>
                  </tr>
                </table>
